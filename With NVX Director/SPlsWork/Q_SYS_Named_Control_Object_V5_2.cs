...
namespace UserModule_Q_SYS_NAMED_CONTROL_OBJECT_V5_2
{
    public class UserModuleClass_Q_SYS_NAMED_CONTROL_OBJECT_V5_2 : SplusObject
    {
...
public UserModuleClass_Q_SYS_NAMED_CONTROL_OBJECT_V5_2 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
