...
namespace CrestronModule_SEND_EMAIL
{
    public class CrestronModuleClass_SEND_EMAIL : SplusObject
    {
...
public CrestronModuleClass_SEND_EMAIL ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
